...
const Footer = () => {
    ...
    return <>
        <footer className='footerContainer'>
            <p>©2024 林陌青川 | LinMo</p>
            <p style={{ marginTop: 5, fontSize: '0.9em', opacity: 0.8 }}><span style={{ fontWeight: 'bold', color: '#dea584' }}>Rust</span> & <span style={{ fontWeight: 'bold', color: '#a7b1c2' }}>Axum</span> Refactored, Extended &Optimized by Sora Saudade (2026)</p>
